...
#hand-writiing sans-serif
cv2.putText(img, "Script Simplex", (50, 330), cv2.FONT_HERSHEY_SCRIPT_COMPLEX, 1, (0, 0, 0))

#sans-serif + italic
cv2.putText(img, "Plain Italic", (50, 430), cv2.FONT_HERSHEY_PLAIN|cv2.FONT_ITALIC, 1, (0, 0, 0))

cv2.putText(img, "Complex Italic", (50, 470), cv2.FONT_HERSHEY_COMPLEX_SMALL|cv2.FONT_ITALIC, 1, (0, 0, 0))
